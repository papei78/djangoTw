...
class BookTitleForm(forms.ModelForm):
    class Meta:
        ...
        # widgets= {
        #     'title':forms.TextInput(attrs= {'class':'border bg-purple-200 p-3'}),
        #     'author':forms.Select(attrs= {'class':'border bg-purple-200 p-3'}),
        #     'publisher':forms.Select(attrs= {'class':'border bg-purple-200 p-3'})
        # }
