...
class  BookTitleListView(FormView,ListView):
    ...
    def form_valid(self,form):
        ...
        messages.add_messages(self.request, messages.INFO, f"Book title: {self.i_instance.title} has been created  ")
...
#     return render(request, 'books/main.html', {'qs':qs})
    def form_invalid(self,form):
            ...
            messages.add_messages(self.request, messages.ERROR , form.errors)
